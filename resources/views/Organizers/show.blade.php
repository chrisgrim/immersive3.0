                ...
                <div class="flex items-center justify-between gap-4">
                    <div class="flex items-center gap-2">
                        ...
                        <p class="text-lg font-medium text-blue-800">
                            Your organization has notes that need to be addressed before approval. Please check your email or <a href="/inbox" class="underline hover:text-blue-900">message inbox</a> to learn more.
                        </p>
                    </div>
                    <div class="flex-shrink-0">
                        <a href="/hosting/events" 
