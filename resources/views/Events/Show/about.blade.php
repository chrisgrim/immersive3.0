        ...
        <div class="py-16 flex items-center gap-4 border-b">
            <a href="{{ route('Organizers.show', $event->organizer->slug) }}" class="flex items-center gap-8">
                ...
                <div class="flex flex-col">
                    <p class="text-1xl font-semibold font-medium">Hosted by {{ $event->organizer->name }}</p>
                    <p class="text-xl font-medium text-neutral-500">{{ count($event->organizer->events) }} events</p>
                </div>
            </a>
        </div>
