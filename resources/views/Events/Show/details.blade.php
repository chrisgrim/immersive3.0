<section class="py-16 md:px-0 border-b border-neutral-200">
    ...
    <div class="mb-16">
        <h3 class="text-3xl md:text-2xl font-medium text-black mb-8">Audience Role</h3>
    ...
    <div class="mb-16">
        <h3 class="text-3xl md:text-2xl font-medium text-black mt-8 mb-4">Content Advisories</h3>
        <div class="grid">
            {{-- Content Advisories --}}
            <div class="border border-neutral-200 p-6 rounded-2xl hover:bg-neutral-50 transition-all duration-200">
                <div class="flex flex-col gap-4">
                    @foreach($event->contentAdvisories as $item)
                        <span class="block rounded-xl text-2xl md:text-1xl">• {{ $item['name'] }}</span>
                    @endforeach
                </div>
            </div>

            <h3 class="text-3xl md:text-2xl font-medium text-black mt-8 mb-4">Interaction Advisories</h3>
            ...
            <h3 class="text-3xl md:text-2xl font-medium text-black mt-8 mb-4">Mobility Advisories</h3>
            {{-- Mobility Advisories --}}
            <div class="border border-neutral-200 p-6 rounded-2xl hover:bg-neutral-50 transition-all duration-200">
                <div class="flex flex-col gap-4">
                    <span class="block text-2xl md:text-1xl">
    ...
    {{-- Tags Section --}}
    <div>
        <h3 class="text-3xl md:text-2xl font-medium text-black mb-8">Tags</h3>
