...
<a href="https://www.facebook.com/sharer/sharer.php?u={{ urlencode(request()->url()) }}" 
    ...
    <svg style="width: 30px; height: 30px;" class="fill-current" viewBox="0 0 24 24">
...
<a href="https://wa.me/?text={{ urlencode($event->name . ' - ' . request()->url()) }}"
    target="_blank"
    class="text-neutral-700 hover:text-green-600 transition-colors">
    <svg style="width: 30px; height: 30px;" class="fill-current" viewBox="0 0 24 24">
...
{{-- Email Share --}}
<a href="mailto:?subject={{ urlencode($event->name) }}&body={{ urlencode('Check out this event: ' . request()->url()) }}"
    class="text-neutral-700 hover:text-red-600 transition-colors">
    <svg style="width: 30px; height: 30px;" class="fill-current" viewBox="0 0 24 24">
