<nav 
	...
	<div 
        style="margin: auto; position: relative; height: 100%; display: grid; grid-template-columns: 1fr minmax(auto, 400px) 1fr; gap: 0; align-items: center; padding-left: 8rem; padding-right: 8rem;"
        class="nav_bar">
