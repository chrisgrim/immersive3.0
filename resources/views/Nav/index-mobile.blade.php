<nav style="height: 16rem;">
    <div 
        ...
        <div 
            style="margin: auto; position: relative; height: 100%; display: grid; grid-template-columns: repeat(3, 1fr); gap: 0; align-items: center; max-width: 1536px; padding: 0 8rem;">
