...
const headerImage = computed(() => {
    if (props.mobile) {
        if (props.value.event_id) {
            return props.value.featured_event_image.thumbImagePath
        }
        return props.value.thumbImagePath
    }
    if (props.value.event_id) {
        return props.value.featured_event_image.largeImagePath
    }
    return props.value.largeImagePath
})
