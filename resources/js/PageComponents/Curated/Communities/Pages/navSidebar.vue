<template>
    ...
    <nav class="flex-shrink-0 space-y-8 w-full p-8 mx-auto mb-20 lg-air:max-w-[40rem] pt-12 lg-air:pt-28">
        ...
        >
            ...
            <p class="text-neutral-600 mb-2 line-clamp-1 break-words hyphens-auto">{{ community.name || 'No name set' }}</p>
            <p class="text-xl text-neutral-500 line-clamp-2 break-words hyphens-auto">{{ community.blurb || 'No blurb set' }}</p>
        </button>
        ...
        >
            ...
            <p class="text-xl text-neutral-600 line-clamp-3 break-words hyphens-auto">{{ community.description || 'No description set' }}</p>
        </button>
