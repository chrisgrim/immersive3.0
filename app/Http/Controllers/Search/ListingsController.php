...
class ListingsController extends Controller
{
    public function http(Request $request)
    {
        ...
        if ($request->searchType === 'inPerson' && isset($request->live)) {
            return view('events.listing-location',compact('searchedEvents', 'categories', 'maxprice', 'tags', 'inPersonCategories', 'searchedCategories', 'searchedTags'));
        }
        if ($request->searchType === 'atHome') {
            return view('events.searchonline',compact('searchedEvents', 'categories', 'tags', 'atHomeCategories', 'searchedCategories', 'searchedTags'));
        }
        return view('events.searchall',compact('searchedEvents', 'categories', 'maxprice', 'tags', 'searchedCategories', 'searchedTags'));
    }
