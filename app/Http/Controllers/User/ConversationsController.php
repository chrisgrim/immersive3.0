...
class ConversationsController extends Controller
{
    ...
    protected function notifyReceiver($receiver, $message, $conversation)
    {
        ...
        // Capture "was caught up" BEFORE the update — Eloquent's update() mutates
        // the in-memory model, so checking $receiver->unread after the update
        // would always be 'm' and the email would never send.
        $wasCaughtUp = $receiver->unread === null;
