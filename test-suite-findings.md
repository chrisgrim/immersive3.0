...
- **50 suspected bugs** logged below (3 high, 20 medium, 28 low). **✅ Fixed 2026-05-29: H1, H2, H3, M1, M2, M3, M4, M6, M7, M8, M9, M10, M11, M12, M13, M14, M15** (L28 added while fixing H1; M11 & M15 fixed by removing dead code; M14 also fixed a latent broken `events()` relation on the advisory models). **M5 re-classified as not-a-bug** (soft-delete intentionally retains images for restore; force-delete cleans up).
