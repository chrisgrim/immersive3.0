...
- **50 suspected bugs** logged below (3 high, 20 medium, 28 low). **✅ Fixed 2026-05-29: H1, H2, H3, M1, M2, M3, M4, M6, M7, M8, M9, M10, M11, M12, M13** (L28 added while fixing H1; M11 fixed by removing the dead code). **M5 re-classified as not-a-bug** (soft-delete intentionally retains images for restore; force-delete cleans up).
